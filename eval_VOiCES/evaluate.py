...
parser.add_argument('--save_path',  type=str, default="../save/proc", help='Save path');
parser.add_argument('--save_filename',  type=str, default="model000000000", help='Save filename');

## Training and test data
parser.add_argument('--test_list',  type=str, default="./list/trials_voices.txt",   help='Evaluation list');
parser.add_argument('--test_path',  type=str, default="/home/shmun/DB/VOiCES/Development_Data/", help='Absolute path to the test set');
